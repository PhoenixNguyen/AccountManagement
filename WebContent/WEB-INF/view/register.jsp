				...
				<div id="w_body">
					...
					<div id="account">
						...
						<%-- <form:form id="registerForm" modelAttribute="account" method="post"
							...
							<form:form method="POST" commandName="account" action="signup">
							...
							<table >
								...
								<tr>
									...
									<td><form:password path="pw" style="width: 80%" placeholder="Mật khẩu"/></td>
								</tr>
								<tr>
									<td style="text-align: right;"><form:label path="name">Tên tài khoản</form:label></td>
									<td><form:input path="name" style="width: 80%" placeholder="họ và tên"/></td>
									<td><form:errors path="name" cssClass="error" /></td>
								</tr>
								<tr>
									<td style="text-align: right;"><form:label path="address">Địa chỉ</form:label></td>
									<td><form:input path="address" style="width: 80%" placeholder="địa chỉ"/></td>
								</tr>
								<tr>
									<td style="text-align: right;"><form:label path="note">Ghi chú</form:label></td>
									<td><form:input path="note" style="width: 80%" placeholder="ghi chú"/></td>
								</tr>
								<tr>
									<td></td>
